  ...
  return (
    <div className='card-education-container animate__animated animate__fadeInUp'>
      ...
      <div className='content'>
        <div className='item'>
          <img className='icon' alt='graduation' src='src/assets/images/major.gif' />
          <p className='label'>Major: </p>
          <p className='value'>Software Engineering</p>
        </div>
        <div className='item'>
          <img className='icon' alt='graduation' src='src/assets/images/gpa.png' />
          <p className='label'>GPA: </p>
          <p className='value'>3.2/4</p>
        </div>
        <div className='item'>
          <img className='icon' alt='graduation' src='src/assets/images/graduation.gif' />
